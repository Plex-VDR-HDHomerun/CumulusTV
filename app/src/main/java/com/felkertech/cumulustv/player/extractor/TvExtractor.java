package com.felkertech.cumulustv.player.extractor;
...
public class TvExtractor implements Extractor {

    private static final String TAG = TvExtractor.class.getName();

    public static class Factory implements ExtractorsFactory {

        private TvExtractor extractor = null;
        ...
        public Extractor[] createExtractors() {
            extractor = new TvExtractor(position, listener, audioLanguage, audioPassthrough);
    ...
    private TvExtractor(PositionReference position, Listener listener, String audioLanguage, boolean audioPassthrough) {
        this.listener = listener;
        this.position = position;
